...
exports.bandascontrollers = void 0;
const database_1 = __importDefault(require("../database"));
const la_tabla = "bandas";
class BandasController {
    ...
    getOne(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const { id } = req.params;
            const query = `SELECT * FROM ${la_tabla} WHERE id =?`;
            yield database_1.default.getConnection((error, connection) => {
                if (error) {
                    console.log(error);
                    return;
    ...
    delete(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const { id } = req.params;
            const query = `DELETE FROM ${la_tabla} where id = ?`;
            yield database_1.default.getConnection((error, connection) => {
                if (error) {
                    console.log(error);
                    return;
    ...
    update(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const { id } = req.params;
            const query = `UPDATE ${la_tabla} set ? where id=?`;
            yield database_1.default.getConnection((error, connection) => {
                if (error) {
                    console.log(error);
                    return;
...
exports.bandascontrollers = new BandasController();
